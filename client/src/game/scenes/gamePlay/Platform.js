...
import {NextStepWin} from "./hud/NextStepWin.js";
...
export class Platform extends  SuperContainer {
    constructor(number, isFinal) {
        ...
        this.winAnimation = this.create.animation({animation: 'Fx05', layer: 'hud', x: 0, y: -75, alpha: 0, anchor: {x: 0.5, y: 0.5}, scale: {x: 0.5, y: 0.5}});
    ...
    showWinValue(value, force = false) {
